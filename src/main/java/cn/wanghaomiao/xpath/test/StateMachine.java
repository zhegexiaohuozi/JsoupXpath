...
public class StateMachine {
    ...
    enum BuilderState {
        SCOPE {
            @Override
            public void parser(StateMachine stateMachine, char[] xpath) {
    ...
    public static void main(String[] args) throws IOException {
        String expression = ".//div[@class='aa']/child::li[contains(./text(),'abc')]";
        ...
        Jsoup.connect("http://www.baidu.com").get().select("");
    }
}
