...
equalityExpr
  :  relationalExpr ('=' relationalExpr)*       #eqExpression
  |  relationalExpr ('!=' relationalExpr)*      #notEqExpression
  ;

relationalExpr
  :  additiveExpr ('<' additiveExpr)*           #ltExpression
  |  additiveExpr ('>' additiveExpr)*           #gtExpression
  |  additiveExpr ('<=' additiveExpr)*          #ltEqExpression
  |  additiveExpr ('>=' additiveExpr)*          #gtEqExpression
  ;

additiveExpr
  :  multiplicativeExpr ('+' multiplicativeExpr)*     #addExpression
  |  multiplicativeExpr ('-' multiplicativeExpr)*     #subtractExpression
  ;

multiplicativeExpr
  :  unaryExprNoRoot ('*' multiplicativeExpr)?          #multiplyExpression
  |  unaryExprNoRoot ('`div`' multiplicativeExpr)?      #divideExpression
  |  unaryExprNoRoot ('`mod`' multiplicativeExpr)?      #modulusExpression
